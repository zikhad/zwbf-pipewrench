...
-- ---------------------------------------------------------------------------
-- ZLBFSimpleUI  (the panel window)
-- ---------------------------------------------------------------------------

ZLBFSimpleUI = ISCollapsableWindow:derive("ZLBFSimpleUI");

function ZLBFSimpleUI:initialise()
    ISCollapsableWindow.initialise(self);
end

function ZLBFSimpleUI:prerender()
...
function ZLBFSimpleUI:addLineToMatrices(isLastLine)
...
function ZLBFSimpleUI:setElementsPositionAndSize()
...
function ZLBFSimpleUI:initAndAddToTable(newE, name)
    newE:initialise();
    newE:instantiate();
    self:addChild(newE);
...
function ZLBFSimpleUI:saveLayout()
    self:nextLine();
...
function ZLBFSimpleUI:setPositionPercent(pctX, pctY)
    local sw = getCore():getScreenWidth();
    local sh = getCore():getScreenHeight();
...
function ZLBFSimpleUI:setPositionPixel(pxlX, pxlY)
    local sw = getCore():getScreenWidth();
    local sh = getCore():getScreenHeight();
...
function ZLBFSimpleUI:setWidthPixel(pxlW)
    self.pxlW = pxlW;
    self.pctW = pxlW / getCore():getScreenWidth();
    self:setWidth(self.pxlW);
end

function ZLBFSimpleUI:setInCenterOfScreen()
    local sw = getCore():getScreenWidth();
    local sh = getCore():getScreenHeight();
...
--- @return ZLBFSimpleUI
function NewZLBFUI()
    local ui = ZLBFSimpleUI:new(0.4, 0.4, 0.2);
    ui:initialise();
    ui:instantiate();
    table.insert(allZLBFUI, ui);
    return ui;
end
