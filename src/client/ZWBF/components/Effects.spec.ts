...
describe("Effects",() => {
    ...
    describe("Debug Enabled", () => {
        ...
        describe("ZomboWin Unblessing trait", () => {
            it.each([
                {
                    ...
                    amount: 100,
                    expected: () =>
                        expect(setInfectionLevel).toHaveBeenCalledWith(0)
                },
                {
                    trait: true,
                    amount: 0,
                    expected: () =>
                        expect(setInfectionLevel).not.toHaveBeenCalled()
                },
                {
                    trait: false,
                    amount: 100,
            ...
            ("should call (or not) when player has trait is $trait and amount is $amount", ({ trait, amount, expected }) => {
