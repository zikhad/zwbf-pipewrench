...
describe("Moodles", () => {
    ...
    describe("MoodleFramework is active", () => {
        ...
        it.each<{ type: "Good" | "Bad" }>([
            { type: "Good" },
            { type: "Bad" },
        ])("should create a $type Moodle instance with correct properties", ({ type }) => {
        ...
        it.each<{ type: "Good" | "Bad" }>([
            { type: "Good" },
            { type: "Bad" },
        ])("Should call MF methods when a $type moodle is call", ({ type }) => {
            const moodle = new Moodle({
                name: "TestMoodle",
                player,
                texture: "test_texture.png",
    ...
    describe("MoodleFramework is inactive", () => {
        ...
        it.each<{ type: "Good" | "Bad" }>([
            { type: "Good" },
            { type: "Bad" },
        ])("Should call a HaloText as Fallback for a $type moodle", ({ type }) => {
