/** @noSelfInFile */
import { getSpecificPlayer, getText, InventoryItem, ISBaseTimedAction, IsoGameCharacter } from "@asledgehammer/pipewrench";
...
export class ZWBFInventory {
    ...
    private handleItemAction(item: InventoryItem, player: IsoGameCharacter, action: ISBaseTimedAction) {
        ISInventoryPaneContextMenu.transferIfNeeded(player, item);
        ISTimedActionQueue.add(action)
    }
    public buildInventoryContextMenu(playerId: number, context: MenuContext, items: InventoryItem[]) {
